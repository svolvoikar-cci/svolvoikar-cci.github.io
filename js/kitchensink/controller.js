...
function addAccessors($scope) {
    ...
    $scope.addText = function() {
        ...
        var textSample = new fabric.Text(text.slice(0, getRandomInt(0, text.length)), {
            left: getRandomInt(0, 0),
            top: getRandomInt(0, 0),
    ...
    function ImageAsCanvasBackground(imageName) {

        fabric.Image.fromURL('assets/templates/' + imageName, function(image) {
            console.log('assets/templates/' + imageName);
            image.set({
                    left: 0,
                    top: 0,
                    angle: getRandomInt(0, 0)
    ...
    function ImageAsCanvasBackgroundWithText(imageName, speakerDetails, messageDetails) {
        fabric.Image.fromURL('assets/templates/' + imageName, function(image) {
            console.log('assets/templates/' + imageName);
            image.set({
                    left: 0,
            ...
            addTextsValues(speakerDetails);
            addTextsValues(messageDetails);
    ...
    function readTextFile(file, callback) {
        //http://stackoverflow.com/a/34579496
    ...
    function addTextsValues(Details) {
        var iText = new fabric.IText(Details.textToDisplay, {
            left: Details.originX,
            top: Details.originY,
        ...
        console.log("Details : " + Details.textToDisplay + " font : " + Details.font + "  fontsize " + Details.fontsize + " fontFamily : " + Details.font + "  left : " + Details.originY + "   top : " + Details.originX + " color : " + Details.textColor);
        canvas.add(iText);
    }



    $scope.addPackImageAsCanvasBackground = function(packname, imageName, jsonfilename) {
        //Clear the canvas
        canvas.clear();
        ...
        //Read the json file and get the required details
        readTextFile("assets/templates/" + packname + "/" + jsonfilename, function(text) {
            var data = JSON.parse(text);
            var templatesArray = data.packs[0].templates;
            var lengthOfArray = Object.keys(templatesArray).length;

            var KeyName = imageName.substr(0, imageName.lastIndexOf('.'));
            var templateObject = templatesArray[KeyName];
            console.log("Name : " + templateObject.name);
            console.log("Thumb nail : " + templateObject.preview);

            //Qoute
            console.log("Is Photo Allowed : " + templateObject.quoteTileSettings.isPhotoAllowed);
            console.log("speakerSettings setting ");
            console.log("   originY : " + templateObject.quoteTileSettings.speakerSettings.originY);
            console.log("   originX : " + templateObject.quoteTileSettings.speakerSettings.originX);
            console.log("   height : " + templateObject.quoteTileSettings.speakerSettings.height);
            console.log("   width : " + templateObject.quoteTileSettings.speakerSettings.width);
            console.log("   fontSize : " + templateObject.quoteTileSettings.speakerSettings.fontSize);
            console.log("   font : " + templateObject.quoteTileSettings.speakerSettings.font);
            console.log("   textColor : " + templateObject.quoteTileSettings.speakerSettings.textColor);



            console.log("messageSettings setting ");
            console.log("   originY : " + templateObject.quoteTileSettings.messageSettings.originY);
            console.log("   originX : " + templateObject.quoteTileSettings.messageSettings.originX);
            console.log("   height : " + templateObject.quoteTileSettings.messageSettings.height);
            console.log("   width : " + templateObject.quoteTileSettings.messageSettings.width);
            console.log("   fontSize : " + templateObject.quoteTileSettings.messageSettings.fontSize);
            console.log("   font : " + templateObject.quoteTileSettings.messageSettings.font);
            console.log("   textColor : " + templateObject.quoteTileSettings.messageSettings.textColor);


            if (templateObject.quoteTileSettings.isPhotoAllowed) {
                var photoArray = templateObject.quoteTileSettings.photos;

                for (var i = 0; i < photoArray.length; i++) {
                    var singlePhoto = photoArray[i];
                    console.log("   Photo # : " + (i + 1));
                    console.log("       shapeType : " + singlePhoto.shapeType);
                    console.log("       zPlacement : " + singlePhoto.zPlacement);
                    console.log("       photoOriginX : " + singlePhoto.photoOriginX);
                    console.log("       photoOriginY : " + singlePhoto.photoOriginY);
                    console.log("       photoHeight : " + singlePhoto.photoHeight);
                    console.log("       photoWidth : " + singlePhoto.photoWidth);
                }
            }

            var speakerDetails = {
                textToDisplay: "- Lee, 10",
                font: templateObject.quoteTileSettings.speakerSettings.font,
                fontsize: templateObject.quoteTileSettings.speakerSettings.fontSize,
                textColor: templateObject.quoteTileSettings.speakerSettings.textColor,
                originX: templateObject.quoteTileSettings.speakerSettings.originY * 100,
                originY: templateObject.quoteTileSettings.speakerSettings.originX * 100
            };

            var messageDetails = {
                textToDisplay: "Message - Presley dias, test text is here!",
                font: templateObject.quoteTileSettings.messageSettings.font,
                fontsize: templateObject.quoteTileSettings.messageSettings.fontSize,
                textColor: templateObject.quoteTileSettings.messageSettings.textColor,
                originX: templateObject.quoteTileSettings.messageSettings.originY * 100,
                originY: templateObject.quoteTileSettings.messageSettings.originX * 100
            };
            ImageAsCanvasBackgroundWithText(packname + "/" + imageName, speakerDetails, messageDetails);
    ...
    $scope.addImageAsCanvasBackground = function(imageName) {
        //Clear the canvas
        canvas.clear();
        ImageAsCanvasBackground(imageName);
    };

    function addImageFromOnlineURL(imageName, minScale, maxScale) {
        var coord = getRandomLeftTop();
    ...
    function addImageFromCanvasResized(imageName) {
        var coord = getRandomLeftTop();
    ...
    $scope.addImageWithURl = function() {
        var base64Image = document.getElementById("mypic").src;
        //console.log("Base64Image: " + base64Image);
        addImageFromOnlineURL(base64Image.toDataURL(), 0.1, 0.25);
    };


    $scope.addImageFromCanvas = function() {
        var base64Image = document.getElementById("canvasid");
        addImageFromCanvasResized(base64Image.toDataURL());
    };
